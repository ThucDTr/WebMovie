                    ...
                    <div className="">
                        <div className="col-sm-8">
                            ...
                            {comments.map((comment, index) => {
                                return (
                                    <div className="media">
                                        <Link className="pull-left" to="#"><img className="media-object" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNL_ZnOTpXSvhf1UaK7beHey2BX42U6solRA&usqp=CAU" alt="" /></Link>
